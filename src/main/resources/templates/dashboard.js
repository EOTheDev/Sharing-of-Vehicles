...
$("#visualizzo").on("change", function () {
    ...
    if ($("#visualizzo").val()=="Seleziona") {
        $("#visualizza").innerHTML='<i class="fas fa-arrow-down"></i>';
        
        //nulla
    } else if($("#visualizzo").val()=="prenotazioni") {
        console.log("sono prima del table");
        $("#visualizza").text("le tue prenotazioni");
        ...
        $("#visualizza").text("i tuoi clienti");
        ...
        $("#visualizza").text("i tuoi veicoli");
